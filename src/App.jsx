...
const PHRASES=[
  {cat:"Sa Phub",catEn:"In the Pub",emoji:"🍺",items:[
    ...
    {irish:"Leath-cheann, le do thoil",pron:"LAH-hyan, le duh HULL",en:"A half-pint, please"},
    {irish:"Cé mhéad?",pron:"KAY vayd",en:"How much?"},
    {irish:"Sláinte!",pron:"SLAWN-chuh",en:"Cheers!"},
    {irish:"Sláinte mhaith!",pron:"SLAWN-chuh VAH",en:"Good health!"},
    {irish:"Mé chugat",pron:"MAY khug-ut",en:"I'll get this round"},
    {irish:"Do bhabhta atá ann",pron:"duh VOW-tuh uh-TAW own",en:"It's your round"},
    {irish:"Tá mé ag ól",pron:"TAW may egg OHL",en:"I am drinking"},
    {irish:"Tá mé tirim anocht",pron:"TAW may CHIR-im uh-NOKHT",en:"I'm off the drink tonight"},
    {irish:"An bhfuil tú ag fanacht?",pron:"un WILL too egg FAN-ukht",en:"Are you staying?"},
    {irish:"Craic maith!",pron:"KRAK mah",en:"Great fun / craic!"},
    {irish:"Céard atá ar siúl?",pron:"KYAWRD uh-TAW er SHOOL",en:"What's going on?"},
    {irish:"Tá an oíche go hiontach",pron:"TAW un EE-huh guh HUN-tukh",en:"The night is great"},
    {irish:"Ceol maith!",pron:"KYOHL mah",en:"Good music!"},
    {irish:"Tá an ceol iontach",pron:"TAW un KYOHL UN-tukh",en:"The music is brilliant"},
    {irish:"Cé a bheidh ag seinnt?",pron:"KAY uh VEJ egg SHEN-ch",en:"Who's playing tonight?"},
    {irish:"Oíche mhaith",pron:"EE-huh VAH",en:"Good night"},
    {irish:"Slán go fóill",pron:"SLAWN guh FOYL",en:"Goodbye for now"},
    {irish:"Go raibh maith agat",pron:"GUH rev mah UG-ut",en:"Thank you"},
    {irish:"Tá mé ar meisce",pron:"TAW may er MESH-kuh",en:"I am drunk"},
  ]},
  {cat:"Ag Siopadóireacht",catEn:"Shopping",emoji:"🛍️",items:[
    ...
    {irish:"Cá bhfuil na seomraí feistis?",pron:"KAW will nuh SHOH-mree FESH-chish",en:"Where are the fitting rooms?"},
    {irish:"Tá sé ró-dhaor",pron:"TAW shay ROH geer",en:"It's too expensive"},
    {irish:"An bhfuil sé níos saoire?",pron:"un WILL shay NEESH SEER-uh",en:"Is it cheaper?"},
    {irish:"An féidir liom é seo a thrail?",pron:"un FAY-jir lum AY shuh uh HRALL",en:"Can I try this on?"},
    {irish:"Cárta creidmheasa",pron:"KAWR-tuh KREJ-vah-suh",en:"Credit card"},
    {irish:"Airgead tirim",pron:"AR-ih-gid CHIR-im",en:"Cash"},
    ...
    {irish:"An féidir liom é seo a cheannach?",pron:"un FAY-jir lum AY shuh uh HYAN-ukh",en:"Can I buy this?"},
    {irish:"An bhfuil sé ar fáil i ndath eile?",pron:"un WILL shay er FAWL ih NOW EL-uh",en:"Is it available in another colour?"},
    {irish:"An bhfuil méid eile agat?",pron:"un WILL MAY-id EL-uh ug-ut",en:"Do you have another size?"},
    {irish:"Tá sé beagán mór",pron:"TAW shay BYUG-awn MORE",en:"It's a little too big"},
    {irish:"Tá sé beagán beag",pron:"TAW shay BYUG-awn byog",en:"It's a little too small"},
    {irish:"Tabhair dom admháil, le do thoil",pron:"TUR dum OW-vawl, le duh HULL",en:"Give me a receipt, please"},
    {irish:"An féidir liom é a thabhairt ar ais?",pron:"un FAY-jir lum AY uh HUR er ASH",en:"Can I return it?"},
  ]},
  {cat:"Ag Taisteal",catEn:"Travelling",emoji:"✈️",items:[
    ...
    {irish:"Cathain a fhágann an traein?",pron:"KAH-hin uh AW-gun un TREN",en:"When does the train leave?"},
    {irish:"Ticéad amháin go...",pron:"chih-KAYD uh-VAWN guh",en:"One ticket to..."},
    {irish:"Dhá thicéad, le do thoil",pron:"GAW HIH-kayd, le duh HULL",en:"Two tickets, please"},
    ...
    {irish:"Cá háit a bhfuil an stáisiún?",pron:"KAW hawch uh WILL un STAW-shoon",en:"Where is the station?"},
    {irish:"Cá bhfuil stad an bhus?",pron:"KAW will STOD un VUS",en:"Where is the bus stop?"},
    {irish:"An bhfuil sé in aice leis an gCaisleán?",pron:"un WILL shay inn AK-uh lesh un GASH-lawn",en:"Is it near the castle?"},
    {irish:"Tá mé caillte",pron:"TAW may KAL-chuh",en:"I am lost"},
    {irish:"An féidir leat é seo a thaispeáint ar an léarscáil?",pron:"un FAY-jir lyat AY shuh uh HASH-pawnt er un LAY-ur-skawl",en:"Can you show me on the map?"},
    {irish:"Cá bhfuil an t-aerfort?",pron:"KAW will un TARE-furt",en:"Where is the airport?"},
    {irish:"An bhfuil aon ticéid fágtha?",pron:"un WILL AYN chih-KAYD FAWG-huh",en:"Are there any tickets left?"},
    {irish:"An bhfuil sé in aisce?",pron:"un WILL shay inn ASH-kuh",en:"Is it free (of charge)?"},
  ]},
  {cat:"Treoracha",catEn:"Directions",emoji:"🧭",items:[
    ...
    {irish:"Tóg an dara casadh",pron:"TOHG un DAR-uh KAS-uh",en:"Take the second turn"},
    {irish:"Tá sé gar",pron:"TAW shay GAR",en:"It's nearby"},
    {irish:"Lean ar aghaidh",pron:"LYAN er EYE",en:"Keep going / Carry on"},
    {irish:"Ag na soilse tráchta",pron:"egg nuh SUL-shuh TRAWKH-tuh",en:"At the traffic lights"},
    {irish:"Trasnaigh an tsráid",pron:"TROSS-nee un TRAWJ",en:"Cross the street"},
    {irish:"Idir an banc agus an eaglais",pron:"ID-ir un BONK UG-us un AG-lish",en:"Between the bank and the church"},
    {irish:"Tá sé cúpla nóiméad siúil",pron:"TAW shay KOO-pluh NOH-mayd SHOOL",en:"It's a few minutes' walk"},
    {irish:"Síos an bóthar",pron:"SHEESS un BOH-hur",en:"Down the road"},
    {irish:"Suas an cnoc",pron:"SOO-us un KNUK",en:"Up the hill"},
    {irish:"Thar an droichead",pron:"HUR un DREH-hud",en:"Over / past the bridge"},
  ]},
  {cat:"Ag Bualadh le Daoine",catEn:"Meeting People",emoji:"🤝",items:[
    {irish:"Dia dhuit",pron:"JEE-uh gwit",en:"Hello (lit: God be with you)"},
    {irish:"Dia is Muire dhuit",pron:"JEE-uh iss MWIR-uh gwit",en:"Hello back (lit: God and Mary be with you)"},
    {irish:"Conas atá tú?",pron:"KUN-us uh-TAW too",en:"How are you?"},
    {irish:"Tá mé go maith, go raibh maith agat",pron:"TAW may guh MAH, GUH rev mah UG-ut",en:"I'm well, thank you"},
    ...
    {irish:"Is as... mé",pron:"iss oss... may",en:"I'm from... (place)"},
    ...
    {irish:"Labhraím beagán Gaeilge",pron:"LOW-reem BYUH-gawn GWAYLIGUH",en:"I speak a little Irish"},
    {irish:"Táim ag foghlaim Gaeilge",pron:"TAW-im egg FOW-lim GWAYLIGUH",en:"I am learning Irish"},
    {irish:"Cén aois tú?",pron:"KAYN eesh too",en:"How old are you?"},
    {irish:"Tá mé... bliana d'aois",pron:"TAW may... BLEE-un-uh DEESH",en:"I am ... years old"},
    {irish:"Cad a dhéanann tú?",pron:"KOD uh YAY-nun too",en:"What do you do for work?"},
    {irish:"Cá bhfuil tú i do chónaí?",pron:"KAW will too ih duh KHOH-nee",en:"Where do you live?"},
    {irish:"Slán agat",pron:"SLAWN ug-ut",en:"Goodbye (said to person staying)"},
    {irish:"Slán leat",pron:"SLAWN lyat",en:"Goodbye (said to person leaving)"},
    {irish:"Tá súil agam go bhfeicfidh mé arís thú",pron:"TAW SOOL ug-um guh VEK-ih may uh-REESH hoo",en:"I hope to see you again"},
  ]},
  {cat:"Aimsir",catEn:"Weather",emoji:"🌦️",items:[
    {irish:"Cén sort aimsire atá ann?",pron:"KAYN sort AM-shir-uh uh-TAW own",en:"What's the weather like?"},
    {irish:"Tá sé go hálainn inniu",pron:"TAW shay guh HAW-linn INN-yoo",en:"It's beautiful today"},
    {irish:"Tá sé ag cur báistí",pron:"TAW shay egg KUR BAWSH-chee",en:"It's raining"},
    {irish:"Tá sé ag cur go trom",pron:"TAW shay egg KUR guh TRUM",en:"It's raining heavily"},
    {irish:"Tá sé fuar inniu",pron:"TAW shay FOO-ur INN-yoo",en:"It's cold today"},
    {irish:"Tá sé rófhuar",pron:"TAW shay ROH-oo-ur",en:"It's too cold"},
    {irish:"Tá sé te",pron:"TAW shay CHEH",en:"It's hot"},
    {irish:"Tá sé breá",pron:"TAW shay BRYAH",en:"It's fine / pleasant"},
    {irish:"Tá sé gaofar",pron:"TAW shay GAY-fur",en:"It's windy"},
    {irish:"Tá stoirm ann",pron:"TAW STURM own",en:"There's a storm"},
    {irish:"Tá sneachta ann",pron:"TAW SHNAKH-tuh own",en:"There's snow"},
    {irish:"Tá sioc ann",pron:"TAW SHUK own",en:"There's frost"},
    {irish:"Tá ceomhar ann",pron:"TAW KYOH-ur own",en:"It's foggy / misty"},
    {irish:"Tá ceo ar na cnoic",pron:"TAW KYOH er nuh KNIK",en:"There's mist on the hills"},
    {irish:"Tá sé ag éirí níos fearr",pron:"TAW shay egg AY-ree NEESH far",en:"It's getting better"},
    {irish:"Tá sé ag éirí níos measa",pron:"TAW shay egg AY-ree NEESH MAS-uh",en:"It's getting worse"},
    {irish:"Cé chomh fuar é!",pron:"KAY HO FOO-ur ay",en:"How cold it is!"},
    {irish:"Tipiciúil d'Éirinn!",pron:"TIP-ih-kyool DAY-rinn",en:"Typical of Ireland!"},
  ]},
  {cat:"Caifé agus Bialann",catEn:"Café & Restaurant",emoji:"☕",items:[
    {irish:"Tá ocras orm",pron:"TAW UK-russ ur-um",en:"I am hungry"},
    {irish:"Tá tart orm",pron:"TAW TORT ur-um",en:"I am thirsty"},
    {irish:"Tábla do dhá dhuine, le do thoil",pron:"TAW-bluh duh GAW GWIN-uh, le duh HULL",en:"A table for two, please"},
    {irish:"An féidir liom an biachlár a fheiceáil?",pron:"un FAY-jir lum un BEE-ukh-lawr uh EK-awl",en:"Can I see the menu?"},
    {irish:"Ba mhaith liom..., le do thoil",pron:"buh WAH lum, le duh HULL",en:"I would like..., please"},
    {irish:"Tae agus toirtín",pron:"TAY UG-us TUR-cheen",en:"Tea and a scone"},
    {irish:"Caife dubh",pron:"KAF-ih DUV",en:"Black coffee"},
    {irish:"Caife le bainne",pron:"KAF-ih le BAN-yuh",en:"Coffee with milk"},
    {irish:"Tá sé blasta!",pron:"TAW shay BLASS-tuh",en:"It's delicious!"},
    {irish:"Tá sé iontach ar fad!",pron:"TAW shay UN-tukh er FOD",en:"It's absolutely fantastic!"},
    {irish:"Níl sé blasta",pron:"NEEL shay BLASS-tuh",en:"It doesn't taste great"},
    {irish:"An bhfuil sé glútan-saor?",pron:"un WILL shay GLOO-tun SAYR",en:"Is it gluten-free?"},
    {irish:"Níl mé in ann feoil a ithe",pron:"NEEL may inn awn FYOHL uh IH-huh",en:"I can't eat meat"},
    {irish:"Táim ina fheisteas",pron:"TAW-im in-uh ESH-tus",en:"I'm vegetarian"},
    {irish:"Ailléirge peanut",pron:"AL-yay-rig-uh peanut",en:"Peanut allergy"},
    {irish:"An cuntas, le do thoil",pron:"un KUN-tus le duh HULL",en:"The bill, please"},
    {irish:"Le chéile nó ar leithligh?",pron:"le HAYLEE noh er LEH-lee",en:"Together or separate (bill)?"},
    {irish:"Tá sé róshaill",pron:"TAW shay ROH-hill",en:"It's too salty"},
  ]},
  {cat:"Bia Traidisiúnta",catEn:"Traditional Food",emoji:"🥣",items:[
    {irish:"Stobhach Gaelach",pron:"STOH-ukh GWAYY-lukh",en:"Irish stew"},
    {irish:"Bacstaí agus cabáiste",pron:"BOK-shtee UG-us kub-AWE-shtuh",en:"Bacon and cabbage"},
    {irish:"Prátaí",pron:"PRAW-tee",en:"Potatoes"},
    {irish:"Putóg dhubh",pron:"PUH-tohg GUV",en:"Black pudding"},
    {irish:"Putóg bhán",pron:"PUH-tohg VAWN",en:"White pudding"},
    {irish:"Toirtín sóide",pron:"TUR-cheen SOH-jih",en:"Soda bread"},
    {irish:"Arán donn",pron:"uh-RAWN DOUN",en:"Brown bread"},
    {irish:"Scailpíní",pron:"SKALP-ee-nee",en:"Colcannon (mashed potato with cabbage)"},
    {irish:"Anlann úll",pron:"ON-lun OOL",en:"Apple sauce"},
    {irish:"Mairteoil stobhtha",pron:"MAR-chohl STOH-uh",en:"Braised beef"},
    {irish:"Éisc agus sceallóga",pron:"AYSK UG-us SHAL-oh-guh",en:"Fish and chips"},
    {irish:"Ceapaire",pron:"KAP-ir-uh",en:"Sandwich"},
    {irish:"Uibheacha scrofa",pron:"IV-ukh-uh SKRUF-uh",en:"Scrambled eggs"},
    {irish:"Ispíní",pron:"ish-PEEN-ee",en:"Sausages"},
    {irish:"Bricfeasta Éireannach",pron:"BRIK-fast-uh AY-run-ukh",en:"Full Irish breakfast"},
  ]},
  {cat:"Teaghlach",catEn:"Family",emoji:"👨‍👩‍👧",items:[
    {irish:"Mo mháthair",pron:"muh VAW-hir",en:"My mother"},
    {irish:"M'athair",pron:"MAH-hir",en:"My father"},
    {irish:"Mo thuismitheoirí",pron:"muh HIS-muh-HOH-ree",en:"My parents"},
    {irish:"Mo dheartháir",pron:"muh YAR-hawr",en:"My brother"},
    {irish:"Mo dheirfiúr",pron:"muh YER-fyoor",en:"My sister"},
    {irish:"Mo mhac",pron:"muh VOK",en:"My son"},
    {irish:"M'iníon",pron:"mih-NEEN",en:"My daughter"},
    {irish:"Mo pháistí",pron:"muh FAW-shtee",en:"My children"},
    {irish:"Mo sheanmháthair",pron:"muh HAN-vaw-hir",en:"My grandmother"},
    {irish:"Mo sheanathair",pron:"muh HAN-ah-hir",en:"My grandfather"},
    {irish:"Mo sheantuismitheoirí",pron:"muh HAN-tish-muh-HOH-ree",en:"My grandparents"},
    {irish:"Mo chol ceathrair",pron:"muh KHOL KAH-rir",en:"My cousin"},
    {irish:"Mo nia",pron:"muh NEE-uh",en:"My nephew"},
    {irish:"Mo neacht",pron:"muh NYAKHT",en:"My niece"},
    {irish:"Mo chara",pron:"muh KHAR-uh",en:"My friend"},
    {irish:"Mo pháirtí",pron:"muh FAR-chee",en:"My partner"},
    {irish:"An bhfuil clann agat?",pron:"un WILL KLONN ug-ut",en:"Do you have children?"},
    {irish:"Tá beirt pháistí agam",pron:"TAW BERSHT FAW-shtee ug-um",en:"I have two children"},
  ]},
  {cat:"Mothúcháin",catEn:"Feelings",emoji:"💭",items:[
    {irish:"Tá áthas orm",pron:"TAW AW-hus ur-um",en:"I am happy"},
    {irish:"Tá mé ar mhuin na muice!",pron:"TAW may er VIN nuh MWIK-uh",en:"I'm over the moon! (lit: on the pig's back)"},
    {irish:"Tá brón orm",pron:"TAW BROHN ur-um",en:"I am sad"},
    {irish:"Tá mé croíbhriste",pron:"TAW may KREE-vrish-chuh",en:"I am heartbroken"},
    {irish:"Tá imní orm",pron:"TAW IM-nee ur-um",en:"I am anxious / worried"},
    {irish:"Tá fearg orm",pron:"TAW FAR-ug ur-um",en:"I am angry"},
    {irish:"Tá mé ar buile",pron:"TAW may er BIL-uh",en:"I am furious"},
    {irish:"Tá tuirse orm",pron:"TAW TIR-shuh ur-um",en:"I am tired"},
    {irish:"Tá mé traochta",pron:"TAW may TRAY-ukh-tuh",en:"I am exhausted"},
    {irish:"Tá mé ceart go leor",pron:"TAW may KYART guh LORE",en:"I am fine / okay"},
    {irish:"Tá mé go hiontach",pron:"TAW may guh HUN-tukh",en:"I am brilliant / fantastic"},
    {irish:"Tá cumha orm",pron:"TAW KOO-uh ur-um",en:"I am homesick / longing"},
    {irish:"Tá iontas orm",pron:"TAW UN-tus ur-um",en:"I am amazed / surprised"},
    {irish:"Tá eagla orm",pron:"TAW AG-luh ur-um",en:"I am afraid"},
    {irish:"Tá náire orm",pron:"TAW NAW-ruh ur-um",en:"I am embarrassed"},
    {irish:"Tá uaigneas orm",pron:"TAW OO-ig-nyus ur-um",en:"I am lonely"},
    {irish:"Tá mé sona sásta",pron:"TAW may SUN-uh SAWSS-tuh",en:"I am happy and content"},
    {irish:"Tá sé ag goilliúint orm",pron:"TAW shay egg GUL-yoont ur-um",en:"It's getting to me / bothering me"},
  ]},
  {cat:"Oifig agus Obair",catEn:"Office & Work",emoji:"💼",items:[
    {irish:"Tá cruinniú agam",pron:"TAW KRIN-yoo ug-um",en:"I have a meeting"},
    {irish:"An féidir leat cabhrú liom?",pron:"un FAY-jir lyat KOW-roo lum",en:"Can you help me?"},
    {irish:"Cén uair a thosaíonn tú?",pron:"KAYN oo-ir uh HUS-een too",en:"What time do you start?"},
    {irish:"Tá mé mall",pron:"TAW may MOWL",en:"I am late"},
    {irish:"Seol dom ríomhphost",pron:"SHOHL dum REEV-fust",en:"Send me an email"},
    {irish:"Cá bhfuil an leithreas?",pron:"KAW will un LEH-ress",en:"Where is the bathroom?"},
    {irish:"Tá mé ag obair ón mbaile",pron:"TAW may egg UB-ir OHN MAL-yuh",en:"I am working from home"},
    {irish:"Tá an tionscadal réidh",pron:"TAW un CHUN-skud-ul RAY",en:"The project is ready"},
    {irish:"Comhghairdeas!",pron:"KOH-gar-jus",en:"Congratulations!"},
    {irish:"Scith mhaith duit",pron:"SKIH VAH dit",en:"Enjoy your rest (said for holidays)"},
    {irish:"Tá sé sin níos deacra",pron:"TAW shay SHIN NEESH JAK-ruh",en:"That's more difficult"},
    {irish:"Ní raibh a fhios agam",pron:"NEE rev ih FUSS ug-um",en:"I didn't know"},
    {irish:"Cad a cheapann tú?",pron:"KOD uh HYAP-un too",en:"What do you think?"},
    {irish:"Aontaím leat",pron:"AYN-teem lyat",en:"I agree with you"},
    {irish:"Ní aontaím leat",pron:"NEE AYN-teem lyat",en:"I disagree with you"},
    {irish:"Beidh mé ar ais faoi cheann leathuaire",pron:"BEJ may er ASH fwee HYOWN LAH-oor-uh",en:"I'll be back in half an hour"},
  ]},
  {cat:"Ag an Dochtúir",catEn:"At the Doctor",emoji:"🏥",items:[
    {irish:"Tá pian orm",pron:"TAW PEE-un ur-um",en:"I am in pain"},
    {irish:"Tá tinneas cinn orm",pron:"TAW CHIN-yus KIN ur-um",en:"I have a headache"},
    {irish:"Tá tinneas fiacaile orm",pron:"TAW CHIN-yus FEE-uh-kil-uh ur-um",en:"I have a toothache"},
    {irish:"Tá mo mhuineál tinn",pron:"TAW muh WHIN-awl cheen",en:"My neck is sore"},
    {irish:"Tá mo droim tinn",pron:"TAW muh DRIM cheen",en:"My back is sore"},
    {irish:"Tá teocht ard orm",pron:"TAW CHYOHKHT AWRD ur-um",en:"I have a high temperature / fever"},
    {irish:"Tá slaghdán orm",pron:"TAW SLIE-dawn ur-um",en:"I have a cold"},
    {irish:"Tá casacht orm",pron:"TAW KAS-ukht ur-um",en:"I have a cough"},
    {irish:"Tá mé ag cur amach",pron:"TAW may egg KUR uh-MOKH",en:"I am vomiting"},
    {irish:"Gortaíodh mé",pron:"GUR-tee-oh may",en:"I was injured"},
    {irish:"Cá bhfuil an t-otharlann?",pron:"KAW will un TUH-hur-lun",en:"Where is the hospital?"},
    {irish:"Tá ailléirge agam do...",pron:"TAW AL-yay-rig-uh ug-um duh",en:"I have an allergy to..."},
    {irish:"Tá mé ar cógais",pron:"TAW may er KOH-gish",en:"I am on medication"},
    {irish:"An féidir liom oideas a fháil?",pron:"un FAY-jir lum EJ-us uh AWIL",en:"Can I get a prescription?"},
    {irish:"Cá fhad a bheidh orm fanacht?",pron:"KAW OD uh VEJ ur-um FAN-ukht",en:"How long will I have to wait?"},
  ]},
  {cat:"Spórt agus Caitheamh Aimsire",catEn:"Sport & Hobbies",emoji:"⚽",items:[
    {irish:"An maith leat spórt?",pron:"un MAH lyat SPOHRT",en:"Do you like sport?"},
    {irish:"Is maith liom peil Ghaelach",pron:"iss MAH lum PEL GWAYY-lukh",en:"I like Gaelic football"},
    {irish:"Is maith liom iománaíocht",pron:"iss MAH lum ih-MAWN-ee-ukht",en:"I like hurling"},
    {irish:"Is maith liom camogie",pron:"iss MAH lum kuh-MOH-gee",en:"I like camogie"},
    {irish:"Imrím peil",pron:"IM-reem PEL",en:"I play football"},
    {irish:"Imrím cispheil",pron:"IM-reem KISH-fel",en:"I play basketball"},
    {irish:"Imrím galf",pron:"IM-reem GOLF",en:"I play golf"},
    {irish:"Téim ag rith",pron:"CHAY-im egg RIH",en:"I go running"},
    {irish:"Téim ag snámh",pron:"CHAY-im egg SNOWV",en:"I go swimming"},
    {irish:"Téim ag rothaíocht",pron:"CHAY-im egg RUH-hee-ukht",en:"I go cycling"},
    {irish:"Tá foireann mhaith ann",pron:"TAW FUR-un VAH own",en:"There's a good team"},
    {irish:"Cé a bhuaigh?",pron:"KAY uh WOO-ig",en:"Who won?"},
    {irish:"Cailleamar",pron:"KAL-yum-ur",en:"We lost"},
    {irish:"Bhain muid amach!",pron:"VAHN mwij uh-MOKH",en:"We achieved it! / We made it!"},
    {irish:"Is maith liom ceol",pron:"iss MAH lum KYOHL",en:"I like music"},
    {irish:"Is maith liom léamh",pron:"iss MAH lum LYAWV",en:"I like reading"},
    {irish:"Seinnim giotár",pron:"SHEN-im gih-TAWR",en:"I play guitar"},
  ]},
  {cat:"Am agus Dátaí",catEn:"Time & Dates",emoji:"🕐",items:[
    {irish:"Cén t-am é?",pron:"KAYN tom ay",en:"What time is it?"},
    {irish:"Tá sé a haon a chlog",pron:"TAW shay uh HUN uh KHLUG",en:"It's one o'clock"},
    {irish:"Tá sé a trí a chlog",pron:"TAW shay uh TREE uh KHLUG",en:"It's three o'clock"},
    {irish:"Tá sé leathuair tar éis a dó",pron:"TAW shay LAH-oor ter AYS uh DOH",en:"It's half past two"},
    {irish:"Tá sé ceathrú tar éis a ceathair",pron:"TAW shay KAH-hroo ter AYS uh KAH-hir",en:"It's quarter past four"},
    {irish:"Cén lá é inniu?",pron:"KAYN LAW ay INN-yoo",en:"What day is it today?"},
    {irish:"Inniu an Luan",pron:"INN-yoo un LOO-un",en:"Today is Monday"},
    {irish:"Inniu an Mháirt",pron:"INN-yoo un VAWRSHT",en:"Today is Tuesday"},
    {irish:"Inniu an Chéadaoin",pron:"INN-yoo un HAYD-een",en:"Today is Wednesday"},
    {irish:"Inniu an Déardaoin",pron:"INN-yoo un JAY-ur-deen",en:"Today is Thursday"},
    {irish:"Inniu an Aoine",pron:"INN-yoo un EEN-uh",en:"Today is Friday"},
    {irish:"Inniu an Satharn",pron:"INN-yoo un SAH-hurn",en:"Today is Saturday"},
    {irish:"Inniu an Domhnach",pron:"INN-yoo un DOH-nukh",en:"Today is Sunday"},
    {irish:"Inniu",pron:"INN-yoo",en:"Today"},
    {irish:"Amárach",pron:"uh-MAW-rukh",en:"Tomorrow"},
    {irish:"Inné",pron:"ih-NAY",en:"Yesterday"},
    {irish:"An tseachtain seo chugainn",pron:"un HYAKH-tin shuh KHUG-inn",en:"Next week"},
    {irish:"An bhliain seo chugainn",pron:"un VLEE-in shuh KHUG-inn",en:"Next year"},
  ]},
  {cat:"Gaeilge Laethúil",catEn:"Everyday Irish",emoji:"☘️",items:[
    {irish:"Sea",pron:"SHA",en:"Yes (agreement / that's it)"},
    {irish:"Tá",pron:"TAW",en:"Yes (it is / I am)"},
    {irish:"Níl",pron:"NEEL",en:"No (it isn't / I'm not)"},
    {irish:"Is ea",pron:"ISHA",en:"Yes (it is — used with 'Is')"},
    {irish:"Ní hea",pron:"NEE HA",en:"No (it isn't — used with 'Is')"},
    {irish:"Le do thoil",pron:"le duh HULL",en:"Please"},
    {irish:"Go raibh maith agat",pron:"GUH rev MAH ug-ut",en:"Thank you"},
    {irish:"Tá fáilte romhat",pron:"TAW FAWL-chuh ROH-ut",en:"You're welcome"},
    {irish:"Gabh mo leithscéal",pron:"GUV muh LEH-shkale",en:"Excuse me / sorry"},
    {irish:"Tá brón orm",pron:"TAW BROHN ur-um",en:"I'm sorry"},
    {irish:"Ceart go leor",pron:"KYART guh LORE",en:"Okay / alright"},
    {irish:"Go maith",pron:"guh MAH",en:"Good / well done"},
    {irish:"Maith thú!",pron:"MAH hoo",en:"Well done! / Good on you!"},
    {irish:"Ar ndóigh",pron:"er NOH-ee",en:"Of course"},
    {irish:"B'fhéidir",pron:"BEJ-ir",en:"Maybe / perhaps"},
    {irish:"Is cuma liom",pron:"iss KUM-uh lum",en:"I don't mind / I don't care"},
    {irish:"Tá a fhios agam",pron:"TAW ih FUSS ug-um",en:"I know"},
    {irish:"Ní raibh a fhios agam",pron:"NEE rev ih FUSS ug-um",en:"I didn't know"},
    {irish:"Ná habair é!",pron:"NAW AB-ir ay",en:"Don't say it! / No way!"},
    {irish:"Iontach ar fad!",pron:"UN-tukh er FOD",en:"Absolutely brilliant!"},
  ]},
  {cat:"Ag an Scoil",catEn:"At School",emoji:"📚",items:[
    {irish:"Cá bhfuil an rang?",pron:"KAW will un RONG",en:"Where is the class?"},
    {irish:"Cén t-am a thosaíonn an rang?",pron:"KAYN tom uh HUS-een un RONG",en:"What time does the class start?"},
    {irish:"Ná déan dearmad",pron:"NAW JAY-un JAR-mud",en:"Don't forget"},
    {irish:"Éist liom, le do thoil",pron:"AYSH-ch lum, le duh HULL",en:"Listen to me, please"},
    {irish:"Féach ar an gclár",pron:"FYAKH er un GLAWR",en:"Look at the board"},
    {irish:"Oscail do leabhar",pron:"US-kil duh LYOW-ur",en:"Open your book"},
    {irish:"Dún do leabhar",pron:"DOON duh LYOW-ur",en:"Close your book"},
    {irish:"Scríobh é sin síos",pron:"SHREEV ay SHIN SHEESS",en:"Write that down"},
    {irish:"Níl tuiscint agam",pron:"NEEL TISH-kint ug-um",en:"I don't understand"},
    {irish:"Cad is brí le...?",pron:"KOD iss BREE le",en:"What does ... mean?"},
    {irish:"An féidir leat é sin a rá arís?",pron:"un FAY-jir lyat ay SHIN uh RAW uh-REESH",en:"Can you say that again?"},
    {irish:"Tá ceist agam",pron:"TAW KYESH-ch ug-um",en:"I have a question"},
    {irish:"An bhfuil an freagra ceart agam?",pron:"un WILL un FRAG-ruh KYART ug-um",en:"Is my answer correct?"},
    {irish:"Tá dul amú orm",pron:"TAW DUL uh-MOO ur-um",en:"I'm confused / I've made a mistake"},
    {irish:"Foghlaim focal nua inniu",pron:"FOW-lim FUK-ul NOO-uh INN-yoo",en:"Learn a new word today"},
  ]},
  {cat:"Nathanna Spraíúla",catEn:"Fun Phrases",emoji:"😄",items:[
    {irish:"Is fearr Gaeilge bhriste ná Béarla cliste",pron:"iss FAR GWAYLIGUH VRISH-chuh NAW BAY-rluh KLISH-chuh",en:"Broken Irish is better than clever English"},
    {irish:"Ná bí ag caint, bí ag déanamh",pron:"NAW bee egg KINT, bee egg JAY-nuv",en:"Don't be talking, be doing"},
    {irish:"Ní neart go cur le chéile",pron:"NEE NYART guh KUR le HAYLEE",en:"There's no strength without unity"},
    {irish:"Is maith an scáthán súil carad",pron:"iss MAH un SKAW-hawn SOOL KAR-ud",en:"A friend's eye is a good mirror"},
    {irish:"Ar scáth a chéile a mhaireann na daoine",pron:"er SKAW uh HAYLEE uh WIR-un nuh DEEN-uh",en:"People live in each other's shadows (we need each other)"},
    {irish:"Tá siúlóid mhaith níos fearr ná leigheas",pron:"TAW SHOOL-ohj VAH NEESH far NAW LYE-us",en:"A good walk is better than medicine"},
    {irish:"Níl aon tinteán mar do thinteán féin",pron:"NEEL ayn TIN-chawn mar duh HIN-chawn FAY-in",en:"There's no hearth like your own hearth (no place like home)"},
    {irish:"Mol an óige agus tiocfaidh sí",pron:"MUL un OH-ig-uh UG-us CHUK-hee shee",en:"Praise the young and they will flourish"},
    {irish:"Is geal leis an bhfiach dubh a ghearrcach féin",pron:"iss GYAL lesh un VEE-ukh DUV uh YAR-ukh FAY-in",en:"The raven thinks his own chick is the fairest (we love our own)"},
    {irish:"Maireann croí éadrom i bhfad",pron:"MAR-un KREE AY-drum ih VOD",en:"A light heart lives long"},
    {irish:"An rud is annamh is iontach",pron:"un RUD iss ON-uv iss UN-tukh",en:"What is rare is wonderful"},
    {irish:"Ithim, ólaim, codlaím",pron:"IH-him, OH-lim, KUD-leem",en:"I eat, I drink, I sleep"},
    {irish:"Is fada an bóthar nach mbíonn casadh ann",pron:"iss FOD-uh un BOH-hur nokh MWEEN KAS-uh own",en:"It's a long road that has no turning"},
    {irish:"Giorraíonn beirt bóthar",pron:"GUR-ee-un BERSHT BOH-hur",en:"Two people shorten a road"},
    {irish:"Caithfidh mé dul anois",pron:"KAH-hee may DUL uh-NISH",en:"I have to go now"},
  ]},
];
...
const GRAMMAR=[
  {
    ...
    rules:[
      {label:"Masculine noun",ex:"an fear",pron:"un FAR",exEn:"the man"},
      {label:"Feminine noun (lenition)",ex:"an bhean",pron:"un VAN",exEn:"the woman"},
      {label:"Plural",ex:"na fir",pron:"nuh FIR",exEn:"the men"},
      {label:"No article = indefinite",ex:"fear",pron:"FAR",exEn:"a man"},
    ],
    tip:"Before a vowel, 'an' becomes 'an t-' for masculine: an t-uisce (un TISH-kuh) = the water.",
  },
  {
    ...
    rules:[
      {label:"mo (my)",ex:"cat → mo chat",pron:"kot → muh KHOT",exEn:"cat → my cat"},
      {label:"do (your)",ex:"bróg → do bhróg",pron:"brohg → duh VROHG",exEn:"shoe → your shoe"},
      {label:"a (his)",ex:"hata → a hata",pron:"HAH-tuh → uh HAH-tuh",exEn:"hat → his hat (h already — no change)"},
      {label:"go (to a place)",ex:"Gaillimh → go Gaillimh",pron:"GAL-iv → guh GAL-iv",exEn:"Galway → to Galway"},
    ],
    tip:"f + h becomes silent: 'fhear' (VEE-er / AR). s + h sounds like H: 'shiopa' (HUP-uh).",
  },
  {
    ...
    rules:[
      {label:"b → mb",ex:"Baile → i mBaile",pron:"BAL-yuh → ih MAL-yuh",exEn:"town → in the town"},
      {label:"c → gc",ex:"Corcaigh → i gCorcaigh",pron:"KUR-kee → ih GUR-kee",exEn:"Cork → in Cork"},
      {label:"d → nd",ex:"doras → ar ndoras",pron:"DUR-us → er NUR-us",exEn:"door → on our door"},
      {label:"g → ng",ex:"Gaillimh → i nGaillimh",pron:"GAL-iv → ih NGAL-iv",exEn:"Galway → in Galway"},
    ],
    tip:"Numbers 2–6 trigger eclipsis: dhá chat (GAW khot) = two cats, trí gchat (tree got) = three cats.",
  },
  {
    ...
    rules:[
      {label:"Tá mé",ex:"Tá mé fuar",pron:"TAW may FOO-ur",exEn:"I am cold"},
      {label:"Tá tú",ex:"Tá tú go maith",pron:"TAW too guh MAH",exEn:"You are well"},
      {label:"Tá sé / sí",ex:"Tá sé fliuch",pron:"TAW shay FLYUKH",exEn:"It / He is wet"},
      {label:"Níl (negative)",ex:"Níl mé tuirseach",pron:"NEEL may TIR-shukh",exEn:"I am not tired"},
    ],
    tip:"Question form: An bhfuil tú...? (un WILL too) = Are you...? → Answer: Tá (yes) / Níl (no).",
  },
  {
    ...
    rules:[
      {label:"Masc. noun",ex:"fear mór",pron:"FAR MORE",exEn:"big man (lit: man big)"},
      {label:"Fem. noun → lenition",ex:"bean bheag",pron:"BAN VYOG",exEn:"small woman"},
      {label:"Plural → slender",ex:"fir mhóra",pron:"FIR VOH-ruh",exEn:"big men"},
      {label:"With 'an'",ex:"an lá breá",pron:"un LAW BRYAH",exEn:"the fine day"},
    ],
    tip:"Most adjectives lenite after feminine nouns: bean → bean mhaith (BAN WAH) = good woman.",
  },
  {
    id:"uimh",title:"Uimhreacha",en:"Numbers",emoji:"🔢",
    intro:"Irish has two number systems: one for counting and one for objects. Counting 1–10 uses cardinal numbers.",
    rules:[
      {label:"1–5",ex:"aon, dhá, trí, ceathair, cúig",pron:"AYN, GAW, TREE, KAH-hir, KOO-ig",exEn:"one, two, three, four, five"},
      {label:"6–10",ex:"sé, seacht, ocht, naoi, deich",pron:"SHAY, SHOKHT, UKH, NEE, DEH",exEn:"six, seven, eight, nine, ten"},
      {label:"Counting people",ex:"beirt, triúr, ceathrar",pron:"BERSHT, TROOR, KAH-rur",exEn:"two people, three people, four people"},
      {label:"Teens: déag",ex:"aon déag, dhá dhéag",pron:"AYN JAY-ug, GAW YAY-ug",exEn:"eleven, twelve"},
    ],
    tip:"'Dhá' (two) always triggers lenition: dhá chat (GAW KHOT) = two cats.",
  },
  {
    id:"ord",title:"Ord na bhFocal",en:"Word Order",emoji:"📐",
    intro:"Irish is VSO — Verb, Subject, Object. The verb always comes first in a statement.",
    rules:[
      {label:"English SVO",ex:"I eat bread",pron:"—",exEn:"Subject → Verb → Object"},
      {label:"Irish VSO",ex:"Ithim arán",pron:"IH-him uh-RAWN",exEn:"(I-)eat bread (verb first!)"},
      {label:"Questions",ex:"An itheann tú arán?",pron:"un IH-hun too uh-RAWN",exEn:"Do you eat bread?"},
      {label:"Negation",ex:"Ní ithim arán",pron:"NEE IH-him uh-RAWN",exEn:"I don't eat bread"},
    ],
    tip:"'Ní' negates the verb. 'An' turns it into a question. No subject pronoun needed in the verb ending.",
  },
];
...
function CelticMandala(){
  // Celtic knotwork helper — each arc is a vesica piscis loop
  const K=(r)=>{const c=Math.round(r*0.55);return `M0,-${r} C${c},-${c} ${c},${c} 0,${c} C-${c},${c} -${c},-${c} 0,-${r}Z`;};
  ...
  const AccTri=({r,dist,sw=1,ga=0.27})=>{
    ...
    return(
      <g fill="none" strokeLinecap="round">
        {[p,p,p].map((_,i)=><path key={i} d={p} transform={`rotate(${i*120})`} stroke={D(0.9)} strokeWidth={sw*3.5}/>)}
        {[p,p,p].map((_,i)=><path key={i} d={p} transform={`rotate(${i*120})`} stroke={G(ga)} strokeWidth={sw}/>)}
      </g>
    );
  };
  ...
  const Interlace=({angles,R,sw=2.5,ga=0.27})=>{
    ...
    return(
      <g fill="none" strokeLinecap="round">
        {gA.map(r=><path key={r} d={p} transform={`rotate(${r})`} stroke={D(0.92)} strokeWidth={sw*3.6}/>)}
        {gA.map(r=><path key={r} d={p} transform={`rotate(${r})`} stroke={G(ga)} strokeWidth={sw}/>)}
        {gB.map(r=><path key={r} d={p} transform={`rotate(${r})`} stroke={D(0.92)} strokeWidth={sw*3.6}/>)}
        {gB.map(r=><path key={r} d={p} transform={`rotate(${r})`} stroke={G(ga)} strokeWidth={sw}/>)}
      </g>
    );
  };
    ...
    <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"none",overflow:"hidden",zIndex:0,opacity:0.20}}>
      <svg viewBox="-700 -700 1400 1400"
        style={{width:"155vmax",height:"155vmax",flexShrink:0,
          filter:"blur(0.4px)",
          animation:"celtRot 90s linear infinite",
        ...
        {Array.from({length:24},(_,i)=>i*15).map(deg=>{
          const rad=deg*Math.PI/180,r1=642,r2=670;
          const x1=Math.round(r1*Math.sin(rad)),y1=Math.round(-r1*Math.cos(rad));
      ...
      {!welcomeTapped?(
        <div onClick={onSplashTap} style={{display:"flex",flexDirection:"column",alignItems:"center",cursor:"pointer",paddingBottom:40}}>
          ...
          <div className="wtitle" style={{
            fontFamily:"'Playfair Display',Georgia,serif",fontSize:"2.1rem",fontWeight:900,
            background:"linear-gradient(135deg,#F4F0E6 0%,#D4983C 45%,#F4F0E6 100%)",
            backgroundSize:"200% auto",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",
            letterSpacing:"-0.02em",lineHeight:1.06,textAlign:"center",marginBottom:7,
            animation:"wFadeUp 0.5s 0.7s ease both,wShimmer 6s 2s linear infinite",
        ...
        <div className="wmenu" style={{width:"100%",maxWidth:430,display:"flex",flexDirection:"column",alignItems:"center",padding:"0 20px 40px",overflowY:"auto"}}>
          ...
          {/* PLAY button */}
          <div className="" style={{width:"100%",marginBottom:10}}>
          ...
          <div className="" style={{width:"100%",display:"flex",gap:8,marginBottom:18}}>
          ...
          {/* Divider */}
          <div className="" style={{display:"flex",alignItems:"center",gap:10,width:"100%",marginBottom:14}}>
          ...
          {/* Settings */}
          <div className="" style={{width:"100%",marginBottom:20}}>
          ...
          {/* Fine print */}
          <div className="" style={{fontFamily:"'Lato',sans-serif",fontSize:"0.6rem",color:"rgba(240,237,228,0.16)",textAlign:"center",lineHeight:1.8,fontStyle:"italic"}}>
                    ...
                    <div style={{display:"flex",flexDirection:"column",gap:8}}>
                      {section.rules.map((rule,i)=>(
                        <div key={i} style={{
                          ...
                          {rule.pron&&rule.pron!=="—"&&<div style={{...bd,fontSize:"0.68rem",color:"rgba(212,152,60,0.65)",letterSpacing:"0.04em",marginBottom:3}}>/{rule.pron}/</div>}
        ...
        {isLockedToday?(
          ...
          <div style={{display:"flex",flexDirection:"column",gap:11,marginTop:16}}>
            ...
            <button onClick={()=>{haptic([10,20,10]);setPrevView("home");
              ...
              borderRadius:14,
              display:"flex",alignItems:"center",justifyContent:"center",gap:10,
              boxShadow:missionLesson?"none":"0 4px 16px rgba(27,67,50,0.5)",
              border:missionLesson?`1px solid ${c.doneBd}`:`1px solid rgba(212,152,60,0.3)`,
            }}>
