...
const PHRASES=[
  {cat:"Sa Phub",catEn:"In the Pub",emoji:"🍺",items:[
    ...
    {irish:"Craic maith!",pron:"KRAK mah",en:"Great fun!"},
  ...
  {cat:"Ag Bualadh le Daoine",catEn:"Meeting People",emoji:"🤝",items:[
    ...
    {irish:"Cad a dhéanann tú?",pron:"KOD uh YAY-nun too",en:"What do you do? (work)"},
  ...
  {cat:"Aimsir",catEn:"Weather",emoji:"🌦️",items:[
    ...
    {irish:"Tá ceomhar ann",pron:"TAW KYOH-ur own",en:"It's foggy"},
  ...
  {cat:"Bia agus Deoch",catEn:"Food & Drink",emoji:"🍽️",items:[
    ...
    {irish:"Tae nó caife?",pron:"TAY noh KAF-ih",en:"Tea or coffee?"},
  ...
  {cat:"Mothúcháin",catEn:"Feelings",emoji:"💭",items:[
    ...
    {irish:"Tá mé ar muin na muice!",pron:"TAW may er MIN nuh MWIK-uh",en:"I'm on top of the world! (lit: on the pig's back)"},
  ...
  {cat:"Oifig agus Obair",catEn:"Office & Work",emoji:"💼",items:[
    ...
    {irish:"Scith mhaith duit",pron:"SKIH VAH dit",en:"Enjoy your rest (goodbye for holidays)"},
  ]},
];
